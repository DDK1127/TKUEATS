                        ...
                        <div class="card">
                          <div class="card-body">
                              ...
                              <form action="" method="post" class="row g-3 needs-validation" novalidate>
								                ...
								                <!-- 顧客全域搜尋（輸入編號、名稱） -->
                                <div class="col-md-6">
                                  <label for="all_customer_label" class="form-label">顧客全域搜尋（輸入編號、名稱）</label><br>
                                  顧客編號<input type="text" name="customer_number" class="form-control" id="all_customer_label" value="">
                                  顧客名稱<input type="text" name="customer_name" class="form-control" id="all_customer_label" value="" >
